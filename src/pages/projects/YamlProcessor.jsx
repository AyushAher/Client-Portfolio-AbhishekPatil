    ...
    <>
      <div className="mt-16 mx-8">
        <section className="header pt-2 mb-16">
          ...
          <h1 className="text-5xl">Email Utility</h1>
        </section>

        <section className="">
          <div className="flex content-between align-center w-full px-16 bg-black overflow-hidden ">
            <img
          ...
          <div className="flex items-start justify-between my-6">
            <div className="flex justify-start items-start gap-4">
              <p className="">
                ...
                <span className="">Nuget Library</span>
              </p>
              <p className="">
                <span className="block font-medium mb-2">Tools</span>
                <span className="">.Net, Nuget</span>
              </p>
              <p className="">
            ...
            <a href="https://github.com/Hyperspan/RamsonDevelopers.UtilEmail">
          ...
          <div className="mb-12">
            <p className="">
              ...
              <span className="">
                RamsonDevelopers.UtilEmail is a versatile .NET class library
                designed to streamline email sending using custom credentials.
                With a simple configuration process, it integrates seamlessly
                into your .NET projects, providing a reliable way to send emails
                programmatically.
              </span>
            </p>
          </div>
