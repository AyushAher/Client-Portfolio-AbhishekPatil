        ...
        <section className="mb-10">
          <div className="grid grid-cols-2 gap-6">
            {array
              ...
              .map((x) => (
                <div className="col-span-2 md:col-span-1 dark:bg-dark dark:text-light-text p-6  hover:outline hover:outline-1 rounded-2xl dark:border hover:outline-gray-200">
