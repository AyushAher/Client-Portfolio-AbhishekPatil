    ...
    <div className="mt-16 mx-8">
      ...
      <section className="mb-10">
        <div className="grid grid-cols-2 gap-6">
          {array.map((x) => (
            <div className="col-span-2 md:col-span-1 bg-white dark:bg-dark dark:text-light-text rounded-2xl dark:outline dark:hover:outline-white p-6  hover:outline hover:outline-1 hover:outline-gray-200 dark:outline-gray-200">
              ...
              >
                ...
                <span className="icon  p-1 bg-white dark:bg-dark dark:border rounded-full relative h-6 w-6 overflow-hidden">
